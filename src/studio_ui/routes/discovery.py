...
def setup_discovery_routes(app):
    ...
    app.post("/api/download_manager/pause/{download_id}")(discovery_handlers.pause_download)
    app.post("/api/download_manager/resume/{download_id}")(discovery_handlers.resume_download)

...
def setup_library_routes(app):
    ...
    app.post("/api/library/optimize_local_scans")(library_handlers.library_optimize_local_scans)
    app.post("/api/library/start_download")(library_handlers.library_start_download)
    app.post("/api/library/download_full")(library_handlers.library_download_full)
    ...
    app.post("/api/library/download_range")(library_handlers.library_download_range)

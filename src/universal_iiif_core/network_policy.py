...
LIBRARY_KEY_ALIASES: dict[str, str] = {
    ...
    "internet culturale": "internet_culturale",
    "internet culturale (iccu)": "internet_culturale",
    "iccu": "internet_culturale",
    "internetculturale": "internet_culturale",
    "estense": "estense",
    "biblioteca estense": "estense",
    "biblioteca estense (modena)": "estense",
    "biblioteca estense universitaria": "estense",
    "edl": "estense",
    "unknown": "unknown",
}
...
DEFAULT_NETWORK_SETTINGS: dict[str, Any] = {
    ...
    "libraries": {
        ...
        "internet_culturale": {
            ...
            "backoff_base_s": 15.0,
            "backoff_cap_s": 300.0,
            "cooldown_on_403_s": 300,
            "cooldown_on_429_s": 300,
            "burst_window_s": 60,
            "burst_max_requests": 40,
            "respect_retry_after": True,
            "prewarm_viewer": False,
            "send_referer_header": True,
            "send_origin_header": False,

...
def _default_cache_dir() -> Path:
    # Use a hidden top-level directory matching the new brand so user data
    # is collected under a single, stable location (e.g., ~/.universal-iiif).
    base = Path.home() / ".universal-iiif"
    return base / "kraken-models"

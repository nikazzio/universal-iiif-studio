...
class IIIFDownloader:
                ...
                for url in urls_to_try:
                    try:
                        ...
                        if r.status_code == 200 and r.content:
                            ...
                            stats = {"page_index": index, "filename": os.path.basename(filename), "original_url": url, "thumbnail_url": thumb_url, "size_bytes": len(
    ...
    def create_pdf(self, files=None):
        ...
        if os.path.exists(output_path):
            output_path = os.path.join(self.pdf_dir, f"{self.ms_id}_from_images.pdf")
